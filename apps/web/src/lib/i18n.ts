...
export type TranslationKey =
  ...
  | "settings.api.descriptionMoonshot"
  | "settings.api.linkTextDeepSeek"
  | "settings.api.linkTextOpenRouter"
  | "settings.api.linkTextOpenAI"
  | "settings.api.linkTextMoonshot"
  | "settings.api.descriptionKimiCode"
  | "settings.api.linkTextKimiCode"
  | "settings.api.descriptionGoogle"
  | "settings.api.linkTextGoogle"
  ...
  | "models.google.geminiFlash.description"
  | "models.google.geminiFlashThinking.description"
  | "models.moonshot.8k.description"
  | "models.moonshot.32k.description"
  | "models.moonshot.128k.description"
  | "models.kimiCode.description"
  ...
  // MCP JSON import
  | "mcp.jsonImport.fromJson"
  | "mcp.jsonImport.tabForm"
  | "mcp.jsonImport.tabJson"
  | "mcp.jsonImport.infoTitle"
  | "mcp.jsonImport.infoDesc"
  | "mcp.jsonImport.pasteLabel"
  | "mcp.jsonImport.placeholder"
  | "mcp.jsonImport.hint"
  | "mcp.jsonImport.parse"
  | "mcp.jsonImport.previewTitle"
  | "mcp.jsonImport.selectAll"
  | "mcp.jsonImport.deselectAll"
  | "mcp.jsonImport.selectedCount"
  | "mcp.jsonImport.import"
  | "mcp.jsonImport.importSuccess"
  | "mcp.jsonImport.importFailed"
  | "mcp.jsonImport.errorEmpty"
  | "mcp.jsonImport.errorInvalidJson"
  | "mcp.jsonImport.errorNoServers"
  | "mcp.jsonImport.errorNoValidServers"
  | "mcp.jsonImport.errorNoSelection"
  // MCP form (additional)
  | "mcp.form.basicInfo"
  | "mcp.form.name"
