...
const de: TranslationDictionary = {
  ...
  "settings": {
    ...
    "api": {
      ...
      "descriptionMoonshot": "Moonshot Kimi, unterstützt ultra-langen Kontext bis zu 128K Tokens",
      "linkTextMoonshot": "Von Moonshot erhalten",
    ...
    "model": {
      ...
      "selectModel": "Modell",
      "contextDepth": "Gedächtnistiefe",
      "contextDepthLabel": "Gedächtnistiefe",
      "contextDepthDescription": "Steuert, wie viel Gesprächsverlauf die KI \"erinnern\" kann. Höhere Stufen bedeuten längeres Gedächtnis, aber mehr Token-Verbrauch.",
      "contextDepthShort": "Kurz (spart Tokens)",
      "contextDepthFull": "Vollständig"
    },
    "notifications": {
  ...
  "models": {
    ...
    "moonshot": {
      "8k": { "description": "Für kurze Unterhaltungen, schnelle Antwort" },
      "32k": { "description": "Für lange Dokumente, ausgewogen" },
      "128k": { "description": "Ultra-langer Kontext, kann ein ganzes Buch verarbeiten" }
    },
    "common": {
